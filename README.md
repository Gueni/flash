...
---
([flash 2.0](https://github.com/Gueni/flash/releases/tag/v2.0)) is a free software which allows the user to access, flash and erase the ESP32 and ESP8266 internal memory. Meanwhile , flash introduces the set of features mentioned in the sections below.
